...
<body>
  ...
  <!-- ✅ Contenedor de Encuestas Contestadas -->
<div class="container">
    <h2 style="text-align: center; color: #333;">Encuestas Contestadas</h2>
            ...
            <?php foreach ($encuestas as $encuesta) : ?>
                <div class="encuesta-card">
                    ...
                    <div class="encuesta-content">
                        ...
                        <span class="btn-disabled">Ya contestada</span>
                    </div>
                </div>
            <?php endforeach; ?>
        <?php else : ?>
            <div class="alert alert-warning text-center">No has contestado ninguna encuesta aún.</div>
        <?php endif; ?>
    </div>
</div>
