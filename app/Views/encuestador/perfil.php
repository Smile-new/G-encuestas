                    ...
                    <div class="perfil-card">
                        ...
                        <form action="<?= base_url('perfil/actualizar') ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="usuario" value="<?= esc($userData['usuario']) ?>"
                                    class="form-control" readonly>
                            </div>

                            <div class="form-group">
                                <label>Nombre(s)</label>
                                <input type="text" name="nombre" value="<?= esc($userData['nombre']) ?>"
                                    class="form-control">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="apellido_paterno"
                                    value="<?= esc($userData['apellido_paterno']) ?>" class="form-control">
                            </div>

                            <div class="form-group">
                                <label>Apellido Materno</label>
                                <input type="text" name="apellido_materno"
                                    value="<?= esc($userData['apellido_materno']) ?>" class="form-control">
                            </div>

                            <div class="form-group">
                                <label>Teléfono</label>
                                <input type="text" name="telefono" value="<?= esc($userData['telefono']) ?>"
                                    class="form-control">
                            </div>
