...
<html lang="es">
   <head>
      ...
      <title>Vota y Opina - Editar Encuestador</title>
      ...
      <div class="full_container">
         <div class="inner_container">
            ...
            <div id="content">
               ...
               <!-- Contenido principal: Formulario de actualización -->
                           ...
                           <div class="white_shd full margin_bottom_30">
                              <div class="full graph_content">
                                 <div class="padding_infor_info">
                                    ...
                                    <?php endif; ?>
                                    <form action="<?= base_url('operador_user/update/' . esc($usuario['id_usuario'])) ?>" method="post" enctype="multipart/form-data">
                                        <?= csrf_field() ?>
                                        <input type="hidden" name="_method" value="POST">
                                        <div class="form-group">
                                            <label for="nombre">Nombre</label>
                                            <input type="text" class="form-control" name="nombre" id="nombre" value="<?= old('nombre', esc($usuario['nombre'])) ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="apellido_paterno">Apellido Paterno</label>
                                            <input type="text" class="form-control" name="apellido_paterno" id="apellido_paterno" value="<?= old('apellido_paterno', esc($usuario['apellido_paterno'])) ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="apellido_materno">Apellido Materno</label>
                                            <input type="text" class="form-control" name="apellido_materno" id="apellido_materno" value="<?= old('apellido_materno', esc($usuario['apellido_materno'])) ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="telefono">Teléfono</label>
                                            <input type="text" class="form-control" name="telefono" id="telefono" value="<?= old('telefono', esc($usuario['telefono'])) ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="usuario">Usuario</label>
                                            <input type="text" class="form-control" name="usuario" id="usuario" value="<?= old('usuario', esc($usuario['usuario'])) ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="contrasena">Nueva Contraseña</label>
                                            <p class="text-muted"><small>Dejar en blanco para no cambiar la contraseña.</small></p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if (!empty($usuario['foto'])): ?>
                                                <img src="<?= base_url('public/img_user/' . esc($usuario['foto'])) ?>" alt="Foto actual" class="img-responsive rounded-circle mb-2" style="width: 100px; height: 100px; object-fit: cover;">
                                            <?php else: ?>
                                        ...
                                        <div class="text-right">
                                            ...
                                            <button type="submit" class="btn btn-primary">Actualizar Encuestador</button>
                                        </div>
                                    </form>
                                 </div>
                              </div>
