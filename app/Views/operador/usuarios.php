            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     <li class="active">
                        <a href="<?= base_url('operador/dashboard') ?>"><i class="fa fa-dashboard yellow_color"></i> <span>Dashboard</span></a>
                     </li>
                     <li><a href="<?= base_url('operador/tablas') ?>"><i class="fa fa-table purple_color2"></i> <span>Tablas</span></a></li>
                     <li><a href="<?= base_url('operador/estadisticas') ?>"><i class="fa fa-bar-chart-o green_color"></i> <span>Estadisticas</span></a></li>
                  </ul>
               </div>
            </nav>
            <div id="content">
                                    ...
                                    <div class="table-responsive-sm">
                                       <table class="table table-striped">
                                          ...
                                          <tbody>
                                              ...
                                              <?php else: ?>
                                                  <tr>
                                                      <td colspan="6" class="text-center">No hay encuestadores registrados.</td>
                                                  </tr>
                                              <?php endif; ?>
                                          </tbody>
                                       </table>
