...
<head>
    ...
    <title>Vota y Opina - Crear Encuesta</title>
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">Completa la información de la encuesta y añade tus
                                        preguntas.</p>
                                    ...
                                    <form class="forms-sample" action="<?= base_url('encuestas/store') ?>"
                                        method="POST">
                                        <?= csrf_field() ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="descripcion" name="descripcion" rows="4"
                                                placeholder="Breve descripción de la encuesta"><?= old('descripcion') ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="activa">Estado</label>
                                            <select class="form-control" id="activa" name="activa" required>
                                                <option value="1" <?= old('activa') == '1' ? 'selected' : '' ?>>Activa
                                                </option>
                                        ...
                                        <p class="card-description">Añade al menos una pregunta con al menos dos
                                            opciones.</p>
                                            ...
                                            if (old('preguntas') && is_array(old('preguntas'))) {
                                                foreach (old('preguntas') as $qIndex => $oldQuestion) {
                                                    ...
                                                    <div class="question-card" data-question-index="<?= $qIndex ?>">
                                                                ...
                                                                foreach ($oldQuestion['opciones'] as $oIndex => $oldOption) {
                                                                    ...
                                                                    <div class="option-item" data-option-index="<?= $oIndex ?>">
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            value="<?= esc($oldOption['texto_opcion'] ?? '') ?>"
                                                                            required>
                                                                        <button type="button"
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-info btn-sm add-option-btn mt-2">Añadir
                                                            Opción</button>
                                                    </div>
                                                    <?php
                                                }
