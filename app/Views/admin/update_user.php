                ...
                <div class="content-wrapper">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a
                                        href="<?= base_url('administrador/dashboard') ?>">Dashboard</a></li>
                                <li class="breadcrumb-item"><a
                                        href="<?= base_url('administrador/usuarios') ?>">Usuarios</a></li>
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Formulario de Edición:
                                        <?= esc($usuario['nombre'] . ' ' . $usuario['apellido_paterno']); ?>
                                    </h4>
                                    ...
                                    <form class="forms-sample"
                                        action="<?= base_url('usuarios/update/' . $usuario['id_usuario']); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nombre" name="nombre"
                                                placeholder="Nombre" value="<?= old('nombre', $usuario['nombre']); ?>"
                                                required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="telefono" name="telefono"
                                                ...
                                                pattern="[0-9]{10}" title="Por favor, ingresa 10 dígitos numéricos">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="usuario" name="usuario"
                                                    placeholder="Clic en 'Generar' para crear uno nuevo"
                                                    value="<?= old('usuario', $usuario['usuario']); ?>" required
                                                    minlength="15">
                                                <div class="input-group-append">
                                                    <button class="btn btn-outline-secondary btn-inverse-primary"
                                                        type="button" onclick="generateRandomUsername()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="contrasena"
                                                    name="contrasena" placeholder="Dejar en blanco para no cambiar"
                                                    minlength="15">
                                                <div class="input-group-append">
                                                    <button class="btn btn-outline-secondary btn-inverse-primary"
                                            ...
                                            <small class="form-text text-muted">Si generas o escribes una contraseña, la
                                                anterior será reemplazada.</small>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if (!empty($usuario['foto'])): ?>
                                                <div class="mb-2">
                                                    <img src="<?= base_url('public/img_user/' . $usuario['foto']); ?>"
                                                        alt="Foto actual" class="img-fluid rounded"
                                                        style="max-width: 100px; max-height: 100px; object-fit: cover;">
                                                </div>
                                            <?php else: ?>
                                                <p class="text-muted">No hay foto actual.</p>
                                            <?php endif; ?>
                                            <label for="foto" class="mt-2">Subir Nueva Foto (reemplaza la
                                                actual)</label>
