    ...
    <style>
        ...
        @media (max-width: 767px) {
            ...
            .table td .btn {
                ...
                width: 100%;
                /* Make buttons full width if they must stack */
        ...
        .chart-container {
            position: relative;
            height: 300px;
            /* Fixed height, but width will be fluid */
            width: 100%;
            margin-bottom: 20px;
                            ...
                            <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                                <div class="navbar-profile">
                                    <img class="img-xs rounded-circle" src="<?= $rutaFotoPerfil ?>"
                                        alt="Foto de perfil">
                                    <p class="mb-0 d-none d-sm-block navbar-profile-name"><?= esc($nombreCompleto) ?>
                                    </p>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-3 grid-margin stretch-card mb-4">
                            <div class="card bg-gradient-danger card-img-holder text-white">
                                <div class="card-body">
                                    <h4 class="font-weight-normal mb-3">Total de Encuestas <i
                        ...
                        <div class="col-sm-6 col-md-3 grid-margin stretch-card mb-4">
                            <div class="card bg-gradient-warning card-img-holder text-white">
                                <div class="card-body">
                                    <h4 class="font-weight-normal mb-3">Encuestas Activas <i
                        ...
                        <div class="col-sm-6 col-md-3 grid-margin stretch-card mb-4">
                            <div class="card bg-gradient-success card-img-holder text-white">
                                <div class="card-body">
                                    <h4 class="font-weight-normal mb-3">Total de Respuestas <i
                        ...
                        <div class="col-sm-6 col-md-3 grid-margin stretch-card mb-4">
                            <div class="card bg-gradient-info card-img-holder text-white">
                                <div class="card-body">
                                    <h4 class="font-weight-normal mb-3">Usuarios Registrados <i
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php if (!empty($ultimasEncuestas)): ?>
                                                    <?php foreach ($ultimasEncuestas as $encuesta): ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div
                                                                    class="badge badge-outline-<?= ($encuesta['activa'] ?? false) ? 'success' : 'danger' ?>">
                                                            ...
                                                            <td>
                                                                ...
                                                                if ($encuestaId !== null):
                                                                    ?>
                                                                    <a href="<?= base_url('encuestas/edit/' . $encuestaId) ?>"
                                                                        class="btn btn-info btn-sm">Editar</a>
                                                                    <a href="<?= base_url('encuestas/view/' . $encuestaId) ?>"
                                                ...
                                                <?php else: ?>
                                                    <tr>
                                                        <td colspan="4" class="text-center">No hay encuestas recientes para
                                                            mostrar.</td>
                                                    </tr>
                                                <?php endif; ?>
                                            </tbody>
