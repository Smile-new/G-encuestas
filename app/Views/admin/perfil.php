        ...
        <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="<?= base_url('operador/perfil/update') ?>" method="post"
                    enctype="multipart/form-data">
                    <?= csrf_field() ?>

                    <div class="form-group">
                      <label>Usuario</label>
                      <input type="text" class="form-control text-usuario"
                    ...
                    <div class="form-group">
                      ...
                      <?php if (!empty($userData['foto'])): ?>
                        <img src="<?= base_url('public/img_user/' . $userData['foto']) ?>"
                          class="img-xs rounded-circle mb-2" alt="Foto de perfil">
                      <?php else: ?>
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted text-center text-sm-left d-sm-inline-block">Copyright © bootstrapdash.com
                2020</span>
