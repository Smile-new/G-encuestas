...
define('RECURSOS_PUBLICOS_JS', 'recursos_publicos/js');
...
define('RECURSOS_USUARIO_SOURCE','recursos_usuario/Source');
define('RECURSOS_USUARIO_SASS','recursos_usuario/sass');
...
define('RECURSOS_ADMIN_VENDORS', 'recursos_admin/vendors');


define('RECURSOS_OPERADOR_CSS', 'recursos_operador/css');
define('RECURSOS_OPERADOR_IMAGES', 'recursos_operador/images');
define('RECURSOS_OPERADOR_JS', 'recursos_operador/js');



define('RECURSOS_ENCUESTADOR_CSS',     'recursos_encuestador/css');
